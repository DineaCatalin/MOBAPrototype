...
public class AbilityDraftLogic : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        EventManager.StartListening(GameEvent.StartRedraft, new System.Action(ShowAbilityDraftUI));
    }
    ...
    {
        background.Show();
        Invoke("ShowBasicAbilityScreen", background.GetFadeInDuration());
    }

    void HideAbilityDraftUI()
    {
        HideSpecialAbilityScreen();
        background.Hide();
    }

    void ShowBasicAbilityScreen()
    {
        basicAbilitiesScreen.Open();
    }

    void ShowSpecialAbilityScreen()
    {
        specialAbilitiesScreen.Open();
    }

    void HideBasicAbilityScreen()
    {
        basicAbilitiesScreen.Close();
    }

    void HideSpecialAbilityScreen()
    {
        specialAbilitiesScreen.Close();
    }

    void SwapAbilityScreens()
    {
        HideBasicAbilityScreen();
        ShowSpecialAbilityScreen();
    }
